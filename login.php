                    ...
                    <div class="row g-5 text-center">
                        ...
                        <form action="login.php" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="password" name="pass" class="form-control bg-transparent" id="pass" placeholder="Enter Your Password" autocomplete="off">
                                        <label for="pass">Your Password</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button class="btn btn-outline-light w-100 py-3" type="login" name="login">Login</button>
                                </div>
                                <p>Don't have an account? <a href="register.php">Register Now</a></p>
                                <a href="admin/admin-login.php" class="btn btn-primary rounded-pill me-2">ADMIN LOGIN</a>
                            </div>
                        </form>
                        <?php } ?>
                    </div>
