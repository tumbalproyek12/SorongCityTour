            ...
            <div class="booking p-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-6 text-white">
                        ...
                        <p class="mb-4">Fitur Booking hanya untuk membooking Tour Guide untuk membantu dalam perjalanan</p>
                        <p class="mb-4">dan fitur ini pengguna dapat meminta Tour Guide untuk pergi ke beberapa tempat sekaligus</p>
                    </div>
                    <div class="col-md-6">
                        <h1 class="text-white mb-4">Booking A Tour Guide</h1>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select bg-transparent" id="select1">
                                            <option value="1">Tanjung Batu</option>
                                            <option value="1">Tanjung Batu +Tour Guide</option>
                                            <option value="2">Tanjung Kasuari</option>
                                            <option value="2">Tanjung Kasuari +Tour Guide</option>
                                            <option value="3">Bukit Love</option>
                                            <option value="3">Bukit Love +Tour Guide</option>
                                            <option value="3">Tembok Berlin</option>
                                        </select>
