              ...
              <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                <div class="col-auto">
                  <form class="docs-search-form row gx-1 align-items-center">
                    ...
                    <div class="col-auto">
                      <a class="btn app-btn-secondary" href="#"><svg width="1em" height="1em" viewBox="0 0 16 16"
              ...
              <div class="app-card app-card-doc shadow-sm h-100">
                ...
                <div class="app-card-body p-3 has-card-actions">
                  <h4 class="app-doc-title truncate mb-0">
                    <a href="#file-link">Lorem ipsum dolor sit amet.</a>
                  </h4>
                      ...
                      <ul class="dropdown-menu">
                        <li>
                          <a class="dropdown-item" href="#"><svg width="1em" height="1em" viewBox="0 0 16 16"
                              class="bi bi-pencil me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd"
                ...
                <div class="app-card-body">
                  <form class="settings-form">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="name" name="name" value="Nama TourGuide" required />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="facebook" name="facebook" value="link Facebok"
                        required />
                    </div>
                    <div class="mb-3">
                  ...
                  if (isset($_POST['simpan'])) {
                    ...
                    $checkTeam = mysqli_query($con, 'SELECT name FROM team WHERE name="$order"');
                    $jumlahTeam = mysqli_num_rows($checkTeam);
                  } else {
                    $simpanTeam = mysqli_query($con, 'INSERT INTO team()');
                  }
                  ?>
                </div>
                <!--//app-card-body-->
